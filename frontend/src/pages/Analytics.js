...
const Analytics = ({ showNotification }) => {
  ...
  }, [selectedUsername, timeRange, comparisonPeriod, customStartDate, customEndDate, showNotification]);
  ...
  }, [selectedUsername, timeRange, comparisonPeriod, customStartDate, customEndDate]); // Only depend on filter values
